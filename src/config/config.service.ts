...
class ConfigService {
    ...
    */
     ...
     */
    public getGoogleRedirect = () => `${this.getValue('HOST', true)}:${this.getValue('PORT', true)}/${this.getValue('GOOGLE_REDIRECT', true)}`
     ...
     */
    public getLinkedInRedirect = () => `${this.getValue('HOST', true)}:${this.getValue('PORT', true)}/${this.getValue('LINKEDIN_REDIRECT', true)}`
